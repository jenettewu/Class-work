...
def draw_button(button_text, button_x, button_y, button_width, button_height, (r, g, b)):
    global playing_pass, leaderboard_pass, instruction_pass, game_scores, score, rank, word_height
    noStroke()
...
def play():
    global player_fish_x, player_fish_y, fish_movement , setting
...
def add_score():
    global game_scores, score, word_height, total_games, game_num
    game_scores.append(score)
    game_num += 1
    total_games.append(game_num)

def leaderboard():
    global total_games, game_scores, word_height, score, game_num
